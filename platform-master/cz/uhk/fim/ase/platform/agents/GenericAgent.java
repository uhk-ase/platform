...
public abstract class GenericAgent implements Runnable {
    ...
    public Message Shop() {
    	//TODO sjednotit do metody kde se bude jen mÏnit produkt, quntity, price, a Ëasem p¯evÈst do decision
    ...
    public Message decision(Message messege) {
    	// rozhodov·nÌ se Ëasem rozroste a d·me ho do samostatn˝ t¯Ìdy
